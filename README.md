...
#### Blend Modes
- [x] ColorBlendKraftShader (GPUImageColorBlendFilter)
- [x] ColorBurnBlendKraftShader (GPUImageColorBurnBlendFilter)
- [x] ColorDodgeBlendKraftShader (GPUImageColorDodgeBlendFilter)
- [x] DarkenBlendKraftShader (GPUImageDarkenBlendFilter)
- [x] DifferenceBlendKraftShader (GPUImageDifferenceBlendFilter)
- [x] DissolveBlendKraftShader (GPUImageDissolveBlendFilter)
- [x] DivideBlendKraftShader (GPUImageDivideBlendFilter)
- [x] ExclusionBlendKraftShader (GPUImageExclusionBlendFilter)
- [x] HueBlendKraftShader (GPUImageHueBlendFilter)
